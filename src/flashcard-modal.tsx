...
export class FlashcardModal extends Modal {
    ...
    constructor(app: App, plugin: SRPlugin, ignoreStats = false) {
        ...
        this.contentEl.addClass("sara-sr-modal-content");
    ...
    decksList(): void {
        ...
        this.titleEl.innerHTML += (
            <p style="margin:0px;line-height:12px;">
                ...
                <span
                    ...
                    class="tag-pane-tag-count tree-item-flair sara-sr-deck-counts"
                >
        ...
        this.contentEl.setAttribute("id", "sara-sr-flashcard-view");
    ...
    setupCardsView(): void {
        ...
        this.fileLinkView = this.contentEl.createDiv("sara-sr-link");
        ...
        this.resetLinkView = this.contentEl.createDiv("sara-sr-link");
        ...
        if (this.plugin.data.settings.showContextInCards) {
            ...
            this.contextView.setAttribute("id", "sara-sr-context");
        }

        this.flashcardView = this.contentEl.createDiv("div");
        this.flashcardView.setAttribute("id", "sara-sr-flashcard-view");

        this.responseDiv = this.contentEl.createDiv("sara-sr-response");

        this.hardBtn = document.createElement("button");
        this.hardBtn.setAttribute("id", "sara-sr-hard-btn");
        ...
        this.goodBtn.setAttribute("id", "sara-sr-good-btn");
        ...
        this.easyBtn.setAttribute("id", "sara-sr-easy-btn");
        ...
        this.answerBtn.setAttribute("id", "sara-sr-show-answer");
        ...
        if (this.ignoreStats) {
            ...
            this.responseDiv.addClass("sara-sr-ignorestats-response");
            this.easyBtn.addClass("sara-sr-ignorestats-btn");
            this.hardBtn.addClass("sara-sr-ignorestats-btn");
        }
    }
    ...
    showAnswer(): void {
        ...
        if (this.currentCard.cardType !== CardType.Cloze) {
            ...
            hr.setAttribute("id", "sara-sr-hr-card-divide");
