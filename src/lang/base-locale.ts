export interface IBaseLocale {
    ...
    MIGRATE_TO_NOTES: string;
    CONFIRM_MIGRATE_TO_NOTES: string;
    MIGRATING_TO_NOTES: string;
    ...
    USE_CALLOUTS_FOR_SCHEDULING_COMMENTS: string;
    USE_CALLOUTS_FOR_SCHEDULING_COMMENTS_DESC: string;
    MIGRATE_SCHEDULING_COMMENTS_TO_CALLOUT_BUTTON: string;
    CONFIRM_MIGRATE_SCHEDULING_COMMENTS_TO_CALLOUT: string;
