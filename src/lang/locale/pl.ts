...
export default {
    ...
    FIX_SEPARATORS_MANUALLY_WARNING: "Pamiętaj, że po zmianie tego musisz ręcznie edytować wszystkie karty zamaskowane, które już masz.",
    ...
    MULTILINE_REVERSED_CARDS_SEPARATOR: "Separator dla kart zamaskowanych odwróconych wieloliniowych",
    NOTES: "Notatki",
    ...
    DISABLE_FILE_MENU_REVIEW_OPTIONS_DESC: "Po wyłączeniu możesz przeglądać za pomocą skrótów klawiszowych. Po zmianie tej opcji konieczne jest ponowne załadowanie Obsidian.",
    ...
    EASY_BONUS_DESC: "Bonus za łatwe pozwala ustawić różnicę w interwałach między odpowiedziami Średnio trudne i Łatwe na fiszce/notatce (minimum = 100%).",
