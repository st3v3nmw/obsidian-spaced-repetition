...
export default {
    ...
    STATUS_BAR: "Revisão: ${dueNotesCount} nota(s), ${dueFlashcardsCount} Carta(s) para colocar em dia",
    ...
    CONVERT_FOLDERS_TO_DECKS_DESC: "Isso é uma alternativa para a opção de etiqueta dos Flashcards em cima.",
    ...
    INITIALLY_EXPAND_SUBDECKS_IN_TREE: "Árvores de baralhos devem inicialmente serem exibidas como expandidas",
    ...
    LAPSE_INTERVAL_CHANGE: "Mudança de intervalo quando você revisa um(a) flashcard/nota como difícil",
