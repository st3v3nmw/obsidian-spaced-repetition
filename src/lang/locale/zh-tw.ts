...
export default {
    ...
    TAGS_TO_REVIEW: "復習標籤",
    TAGS_TO_REVIEW_DESC: "輸入標籤，用空白或換行字元分隔，例如：#review #tag2 #tag3.",
    TAGS_TO_EXCLUDE_FROM_DECKS: "從牌組創建中排除的標籤",
    TAGS_TO_EXCLUDE_FROM_DECKS_DESC: "輸入以空格分隔的標籤。帶有這些標籤的卡片仍將包含在復習中，但不會創建單獨的牌組。這是子組件，例如，如果你有 #flashcards/test，那麼輸入 'test'。",
