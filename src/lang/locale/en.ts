...
const en: IBaseLocale = {
    ...
    CONFIRM_FSRS_ALGORITHM_SWITCH:
        "Switching to FSRS changes how flashcard scheduling data is written. Existing scheduling comments remain readable, but cards reviewed after this change will be rewritten in FSRS format, which requires a lot more parameters and thus a longer, more intrusive, scheduling data comment. There is best effort backwards compatibility for the scheduling comments, in case you might want to switch back to OSR. This means your scheduling data will be rewritten to the OSR format once you review a card with OSR enabled.",
    BASE_EASE: "Base ease",
