...
export default {
    ...
    ENABLE_HABITICA_INTEGRATION_DESC: "Supercharge your spaced repetation and active recall habits.",
    ...
    HABITICA_EASY_TASK_ID_DESC: "The ID of the task that will be scored when you review a flashcard/note as easy.",
    HABITICA_GOOD_TASK_ID: "Good Task ID",
    HABITICA_GOOD_TASK_ID_DESC: "The ID of the task that will be scored when you review a flashcard/note as good.",
    HABITICA_HARD_TASK_ID: "Hard Task ID",
    HABITICA_HARD_TASK_ID_DESC: "The ID of the task that will be scored when you review a flashcard/note as hard.",
