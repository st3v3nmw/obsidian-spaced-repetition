...
export default {
    ...
    CONVERT_FOLDERS_TO_DECKS_DESC: "Bu, yukarıdaki Flash Kart etiketleri seçeneğine bir alternatiftir.",
    ...
    BURY_SIBLINGS_TILL_NEXT_DAY_DESC: "Kardeş kartlar, aynı kart metninden üretilen kartlardır (örneğin gizlemeler).",
    ...
    MULTILINE_CARDS_END_MARKER: "Gizli kartlar ve çok satırlı flash kartların sonunu belirten karakterler",
    NOTES: "Notlar",
    REVIEW_PANE_ON_STARTUP: "Başlangıçta not inceleme panelini etkinleştir",
    TAGS_TO_REVIEW: "Gözden geçirilecek etiketler",
    TAGS_TO_REVIEW_DESC: "Etiketleri boşluklar veya yeni satırlarla ayırarak girin, örneğin: #review #tag2 #tag3.",
    ...
    DISABLE_FILE_MENU_REVIEW_OPTIONS_DESC:
        "Devre dışı bıraktıktan sonra komut kısayollarını kullanarak inceleme yapabilirsiniz. Bu değişiklikten sonra Obsidian'ı yeniden yükleyin.",
    ...
    INITIALLY_EXPAND_SUBDECKS_IN_TREE: "Deste ağaçları başlangıçta genişletilmiş olarak gösterilmeli mi",
    INITIALLY_EXPAND_SUBDECKS_IN_TREE_DESC:
        "Bunu kapatın, aynı dosyada birçok desteye ait kartlarınız varsa iç içe desteleri daraltmak için kullanışlıdır.",
    ALGORITHM: "Algoritma",
    CHECK_ALGORITHM_WIKI: 'Daha fazla bilgi için <a href="${algo_url}">algoritma uygulamasına</a> göz atın.',
    ...
    DISPLAY_PARSER_DEBUG_INFO: "Ayrıştırıcı için hata ayıklama bilgilerini geliştirici konsolunda göster",
