...
export default {
    ...
    TAGS_TO_REVIEW_DESC:
        "Введите теги, разделенные Enter-ом или пробелом, например: #review #tag2 #tag3.",
    TAGS_TO_EXCLUDE_FROM_DECKS: "Теги для исключения из создания колод",
    TAGS_TO_EXCLUDE_FROM_DECKS_DESC: 
        "Введите теги, разделенные пробелами. Карточки с этими тегами все равно будут включены в обзор, но не будут создавать отдельные колоды. Это подкомпоненты, поэтому если у вас есть #flashcards/test, то введите 'test'.",
