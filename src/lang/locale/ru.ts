...
export default {
    ...
    REVIEW_EASY_FILE_MENU: "Изучение: Легко",
    REVIEW_GOOD_FILE_MENU: "Изучение: Нормально",
    REVIEW_HARD_FILE_MENU: "Изучение: Сложно",
    REVIEW_NOTE_EASY_CMD: "Изучать заметку как Лёгкую",
    REVIEW_NOTE_GOOD_CMD: "Изучать заметку как Нормальную",
    REVIEW_NOTE_HARD_CMD: "Изучать заметку как Сложную",
