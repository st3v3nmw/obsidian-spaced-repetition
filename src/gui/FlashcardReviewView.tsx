...
export class FlashcardReviewView {
    ...
    async show() {
        ...
        await wrapper.renderMarkdownWrapper(this._currentCard.front, this.content, this._currentQuestion.questionText.textDirection);
    ...
    private _showAnswer(): void {
        ...
        wrapper.renderMarkdownWrapper(this._currentCard.back, this.content, this._currentQuestion.questionText.textDirection);
