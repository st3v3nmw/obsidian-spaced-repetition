...
-   Centered the button groups, which where not centered
...
-   Improved view switching, such that less redraws are needed
-   Improved DeckListView
-   Improved FlashcardReviewView
-   Improved EditModal
-   Added a bunch of classes for styling
-   Renamed gui files such that they follow a uniform naming convention
