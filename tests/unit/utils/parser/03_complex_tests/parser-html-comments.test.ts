...
test("Test not parsing cards in HTML comments", () => {
    ...
    expect(
        parseT(
            ["<!--", "Some text before", "cloze ==deletion== test", "Some text after", "-->"].join(
                "\n",
            ),
            parserOptions,
        ),
    ...
    ).toEqual([[CardType.SingleLineReversed, "Question:::Answer on same line", 7, 7]]);
    ...
    expect(
        ...
        [
            CardType.Cloze,
            ["Minima", " est autem rem ==CLOZE== consequatur. Est ==CLOZE== fugit iure."].join(
                "\n",
            ),
            0,
            1,
    ...
    expect(
        ...
        [
            ...
            ["Iusto quaerat QUESTION::ANSWER .Eos doloribus consequatur quod"].join("\n"),
            10,
            10,
        ],
        [
