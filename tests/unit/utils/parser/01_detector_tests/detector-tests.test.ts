...
test("Test parsing of SR HTML comments", () => {
    ...
    expect(
        StringDetector.getSRHTMLComment("Some text before <!--SR:2021-08-11,4,270-->", 1),
    ).toEqual({
        startIndex: 17,
        endIndex: 42,
        text: "<!--SR:2021-08-11,4,270-->",
    ...
    expect(
        StringDetector.getSRHTMLComment(
            "Some text before <!--SR:2021-08-11,4,270--> Some text after",
            1,
        ),
    ).toEqual({
        startIndex: 17,
    ...
    expect(
        StringDetector.getSRHTMLComment("<!--SR:2021-08-11,4,270--> Some text after", 1),
    ).toEqual({
        startIndex: 0,
        endIndex: 25,
        text: "<!--SR:2021-08-11,4,270-->",
    ...
    expect(
        StringDetector.getSRCommentsInLine(
            "<!--Some text before <!--SR:2021-08-11,4,270--> Some text after",
            1,
        ),
    ).toEqual([
...
test("Test parsing of HTML comments", () => {
    ...
    expect(
        StringDetector.getHTMLCommentsInLine("Some text before <!--Some text in comment-->", 1),
    ).toEqual([
        {
            startIndex: 17,
            endIndex: 43,
    ...
    expect(
        StringDetector.getHTMLCommentsInLine("<!--Some text in comment--> Some text after", 1),
    ).toEqual([
        {
            startIndex: 0,
            endIndex: 26,
    ...
    expect(
        StringDetector.getHTMLCommentsInLine(
            "Some text before <!--Some text in comment--> Some text after",
            1,
        ),
    ).toEqual([
        {
    ...
    expect(
        StringDetector.getHTMLCommentsInLine(
            "<!--Some text before <!--SR:e text in comment--> <!--Some text after-->-->",
            4,
        ),
    ).toEqual([
        {
    ...
    expect(
        StringDetector.getHTMLCommentsInLine(
            "<!--Some text before <!--Some text in comment--> <!--SR:e text after-->-->",
            4,
        ),
    ).toEqual([
        {
